...
*These stpes are recommende but not requested for the node to work. Even if you receive errors, your node should not be affected and keep running normally.*
### Setup the Firewall
